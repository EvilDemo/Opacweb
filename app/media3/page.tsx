...
import { Media3PageContent } from "@/components/Media3PageContent";

export const metadata: Metadata = {
  title: "Opac Media 3 | Music, Videos & Pictures",
  description:
  ...
  openGraph: {
    ...
    url: "https://weareopac.com/media3",
    siteName: "Opac",
    images: [
      {
        url: "/og-media.jpg",
        width: 1200,
        height: 630,
        alt: "Opac Media 3 - Music, Videos & Pictures",
      },
    ],
    locale: "en_US",
    type: "website",
  ...
  alternates: {
    canonical: "https://weareopac.com/media3",
  },
  robots: {
    index: true,
    follow: true,
...
export default function Media3Page() {
  return <Media3PageContent />;
}
